class Lightbox {
  ...
  buildDOM() {
    ...
    lightbox.innerHTML = `
      ...
      <button class="lightbox__close color"><i class="colorRed cursorPointer fa-sharp fa-solid fa-xmark"></i></button>
      <button class="lightbox__prev"><i class="colorRed cursorPointer fa-solid fa-angle-left"></i></button>
      <button class="lightbox__next"><i class="colorRed cursorPointer fa-solid fa-angle-right"></i></button>
      <div class="boxImg">
